...
async def changelog(message) -> None:
    ...
    embed.add_field(name="v1.3.4", value="- Added new icons for character "
                    ...
                    "added", inline=False)
    embed.add_field(name="v1.3.5", value="Internal code refactoring, shouldn't"
                    "impact functionality but makes the code way less ugly",
                    inline=False)
...
client.run(os.environ.get("DISCORD_TOKEN"))
>>>>>>> 6827d3cd437626be73cda161510a41dd519548a8:main.py
