<<<<<<< HEAD:Brynhildr/summon.py
import discord
from icons import iconreplace
from util import *


async def summonparse(categories: list, source: str, embed: discord.Embed,
                      simple: bool) -> None:
...
async def generateicons(categories: list, embed: discord.Embed) \
    ...
    cat_map = {
        # Rarity icons
        "SSR Summons": " <:Rarity_SSR:730441789667934278>",
        "SR Summons": " <:Rarity_SR:730441789319807009>",
        "R Summons": " <:Rarity_R:730441789642768464>",
        "N Summons": " <:Rarity_N:730441824954482728>",
        # Element icons
        "Fire Summons": " <:Fire:730845600484032624>",
        "Water Summons": " <:Water:730845600324780151>",
        "Earth Summons": " <:Earth:730845600672776202>",
        "Wind Summons": " <:Wind:730845600479707157>",
        "Light Summons": " <:Light:730845600915914873>",
        "Dark Summons": " <:Dark:730845600613924954>",
        # 4/5★ uncap icons
        "4★ Summons": " <:BlueStar:739887435936301152>",
        "5★ Summons": "<:BlueStar:739887435936301152>"
    }
    ...
    for tr in parsed.find_all("tr"):
        ...
        if skillspan <= 1:
            ...
            if cdspan <= 1:
                cd = ""
    return output
>>>>>>> 6827d3cd437626be73cda161510a41dd519548a8:summon.py
